...
description: Use when adding multi-agent team support to Telegram where each subagent has its own bot identity. Requires Telegram channel first. Triggers on "agent swarm", "telegram swarm", "bot pool".
---
